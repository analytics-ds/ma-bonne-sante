...
image: "[/images/blog/nom-image.jpg — optionnel]"
imageAlt: "[Description de l'image — obligatoire si image]"
faq:
  - question: "[Question 1 — variante du mot-cle]"
...
<details>
<summary>[Question 1 — variante du mot-cle] ?</summary>

[Reponse concise, 2-4 phrases, avec donnee si possible.]
...
- Le champ `image` est optionnel mais recommande (affiche dans le hero article et utilise pour og:image et le schema Article)
- Le champ `imageAlt` est obligatoire si `image` est present
