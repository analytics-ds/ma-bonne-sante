...
title: "Tea Tree Essential Oil for Fungal Infections: Usage Guide"
h1: "How to Use Tea Tree Essential Oil Against Fungal Infections?"
date: "2026-05-27"
lastmod: "2026-05-27"
publishDate: "2026-05-27"
description: "Tea tree against fungal infections: application, dilution, duration, foot, nail, skin fungus. Complete protocol for natural treatment."
categories: ["Skincare", "Essential Oils"]
tags: ["tea tree", "fungal infection", "antifungal", "candida albicans", "athletes foot"]
...
faq:
  ...
  - question: "How to apply tea tree on a fungal infection?"
    answer: "For a localized skin fungal infection: 1 pure drop on the area, 2 times a day, after cleaning and drying skin well. For a more extensive area, dilute 1 drop in 4 drops of vegetable oil (jojoba, calendula). For nail fungus, 1 pure drop on the nail 2 times a day. For mucous membranes, dilution mandatory and professional advice."
  - question: "How long to heal a fungal infection with tea tree?"
    answer: "For a superficial skin fungus, count 7 to 14 days of application 2 times a day. For foot fungus (between toes), 2 to 3 weeks. For nail fungus, treatment is much longer: 3 to 6 months, the time for the nail to grow back healthy. Recurrence is frequent, hence the importance of good hygiene in parallel."
  - question: "Can tea tree be used on vaginal fungal infection?"
    answer: "Yes, but with caution and after medical confirmation of diagnosis. Tea tree is never used pure on genital mucous membranes. Recommended dilution: 1 mL of essential oil in 100 mL of intimate gel, in external application 2 times a day. For internal use (ovules, irrigations), medical advice is essential."
  - question: "Which essential oils to combine with tea tree against fungal infections?"
    answer: "Palmarosa (Cymbopogon martinii) is another major antifungal, complementary to tea tree. True lavender for its soothing and healing action. Rose geranium for recurrent skin fungal infections. A typical synergy is to mix equal parts tea tree + palmarosa + true lavender in 20 percent vegetable oil."
readingTime: true
---
...
Note: recurrent vaginal fungal infections require a global assessment (microbiota balance, diet, hygiene). Tea tree alone is not enough in this case, and the background terrain must be worked on, as one would for [female hormonal balance](/en/blog/female-hormonal-balance-natural-brands/).
...
A [quality vegetable oil like sweet almond or calendula](/en/blog/best-organic-vegetable-oil-brands/) constitutes the best vehicle for these dilutions.
...
**Strengthen immune terrain**: a recurrent fungal infection often reflects a fragility of terrain. Probiotic cure, blackcurrant gemmotherapy, diet low in fast sugars that feed yeasts. For repeated candidiasis episodes, see also our article [strengthening your immune system naturally](/en/blog/strengthen-immune-system-naturally/).

## Precautions to Know

The effectiveness of tea tree should not make us forget its precautions of use. Before any use, imperatively read the guide [tea tree essential oil dangers](/en/blog/tea-tree-essential-oil-dangers/) which recalls:
...
<details>
<summary>Does tea tree work on all fungal infections?</summary>
It is very active on strains of Candida albicans, Trichophyton and Malassezia, which cover the vast majority of skin, foot, nail and mucous fungal infections. On rarer or more resistant strains (Aspergillus, some systemic candidiasis), medical treatment remains essential.
</details>

<details>
<summary>Can tea tree be combined with medical antifungal treatment?</summary>
Yes, most often it is even beneficial. Tea tree can complement an antifungal cream or varnish without known interaction. For oral antifungal treatment (Lamisil, fluconazole), ask the doctor's advice to ensure the absence of particular contraindication.
</details>

<details>
<summary>Is tea tree essential oil suitable for children?</summary>
Not before 3 years, and always diluted in older children. For a fungal infection in a child over 3 years old, dilution at 5 to 10 percent maximum in vegetable oil, 1 time a day, over 5 to 7 days. At the slightest doubt, consult a pediatrician or pharmacist.
</details>

<details>
<summary>What if the fungal infection does not disappear after 2 weeks of tea tree?</summary>
Consult a doctor. It may be a resistant strain, an erroneous diagnosis (eczema confused with fungal infection, psoriasis), or weakened terrain (diabetes, immunosuppression). A mycological sample will precisely identify the fungus and adapt the treatment.
</details>
