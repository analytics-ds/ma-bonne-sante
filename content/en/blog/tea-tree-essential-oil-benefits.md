...
tags: ["tea tree", "essential oil", "benefits", "antifungal", "antibacterial", "skincare"]
...
faq:
  ...
  - question: "How to use tea tree essential oil daily?"
    answer: "For acne, place 1 pure drop on the pimple with a cotton swab in the evening. For a fungal infection, 1 drop diluted in vegetable oil morning and evening. As hair care, 2 to 3 drops in a shampoo dose. For diffusion, 5 to 8 drops for 15 minutes to purify the air. Always dilute for prolonged use."
  - question: "What is the difference between tea tree and ravintsara?"
    answer: "Tea tree (Melaleuca alternifolia) is primarily antibacterial, antifungal and skin-purifying, ideal for skin and mucous membranes. Ravintsara (Cinnamomum camphora) is more immunostimulant and antiviral, recommended for prevention and treatment of winter respiratory conditions. Both are complementary in an aromatherapy kit."
  - question: "Can you apply pure tea tree on the skin?"
    answer: "For a very localized and occasional use (a pimple, mouth ulcer, sting, the edge of a fungal nail), one pure drop is tolerated in adults. For any application on a larger area or prolonged, dilution at 10 to 20 percent in vegetable oil (jojoba, sweet almond) is strongly recommended to avoid irritation."
  - question: "Can tea tree essential oil be swallowed?"
    answer: "The oral route is not recommended in self-medication. The terpinen-4-ol and methyleugenol contained in the essential oil can be toxic at poorly controlled doses. If oral intake is considered (resistant infection, candidiasis), it must be supervised by a doctor or aromatherapist pharmacist who will set the precise dosage."
readingTime: true
---
...
By diffusion or application on the chest, tea tree helps to **purify the respiratory tract** during winter conditions: colds, bronchitis, sinusitis. It works in addition to [ravintsara, another major essential oil against ENT infections](/en/blog/essential-oil-unblock-nose/), and can be used to prepare an immunostimulant synergy during epidemic periods.

Its antiviral action, although less powerful than that of eucalyptus radiata or ravintsara, makes it a useful complement to [strengthen the immune system naturally](/en/blog/strengthen-immune-system-naturally/) over winter epidemic periods.
...
Despite its reputation for good tolerance, tea tree requires precise precautions. The main ones are recalled in the guide [tea tree essential oil dangers](/en/blog/tea-tree-essential-oil-dangers/) to consult before any prolonged use.
...
Reference brands like **Pranarom** (Aromaforce range), **Puressentiel** (Bio EO) or **Florame** (certified range) apply these standards. A 10 mL bottle costs between 6 and 12 euros, which makes it one of the most accessible essential oils, like other [reference organic oils](/en/blog/best-organic-vegetable-oil-brands/) on the market.

## Frequently Asked Questions

<details>
<summary>Does tea tree really work against acne?</summary>
Yes, several clinical studies (including one published in the Medical Journal of Australia) have demonstrated its effectiveness comparable to benzoyl peroxide at 5 percent, the reference treatment, with fewer side effects. The effect appears after 4 to 8 weeks of regular use in targeted local application.
</details>

<details>
<summary>How long does it take to heal a fungal infection with tea tree?</summary>
For a superficial skin fungal infection, count 7 to 14 days of application 2 times a day. For nail fungus, treatment is much longer, 3 to 6 months in daily application, the time for the nail to grow back healthy. Medical advice remains recommended for recurrent fungal infections.
</details>

<details>
<summary>Tea tree or tea tree oil: is it the same?</summary>
Yes, these are two names for the same essential oil. "Tea tree" is the English name, derived from the common name of the plant Melaleuca alternifolia. Both designations refer to the same product in aromatherapy.
</details>

<details>
<summary>Can tea tree be used during pregnancy?</summary>
No, tea tree essential oil is not recommended during pregnancy, neither cutaneously nor by diffusion. The active compounds cross the placental barrier and their impact on fetal development is not sufficiently documented. Breastfeeding is also a contraindication.
</details>
